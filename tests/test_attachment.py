...
attachments_resource = [
    {"sys_id": mock_sys_id, "size_bytes": "512", "file_name": "test1.txt"},
    {"sys_id": mock_sys_id, "size_bytes": "1024", "file_name": "test2.txt"},
    {"sys_id": mock_sys_id, "size_bytes": "2048", "file_name": "test3.txt"},
]

attachments_resource_sys_id = [
    {"sys_id": "mock_sys_id1", "size_bytes": "512", "file_name": "test1.txt"},
    {"sys_id": "mock_sys_id2", "size_bytes": "1024", "file_name": "test2.txt"},
]

attachment = {"sys_id": mock_sys_id, "size_bytes": "512", "file_name": "test1.txt"}
...
class TestAttachment(unittest.TestCase):
    ...
    def test_upload_binary(self):
        ...
        response = self.resource.attachments.upload(
            sys_id=mock_sys_id, file_path=attachment_path
        )
    ...
    def test_upload_multipart(self):
        ...
        response = self.resource.attachments.upload(
            sys_id=mock_sys_id, file_path=attachment_path, multipart=True
        )
    ...
    def test_upload_invalid_multipart_type(self):
        ...
        self.assertRaises(
            InvalidUsage, a.upload, mock_sys_id, attachment_path, multipart=dict()
        )
